        ...
        <div className="hidden md:block md:w-1/2 bg-muted">
          <div className="h-full w-full relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-12">
              <h1 className="text-white text-4xl font-bold mb-6">Delicious food, delivered to your door</h1>
              <p className="text-white/90 text-lg max-w-md text-center">
                Order from your favorite restaurants and enjoy a seamless food delivery experience.
              </p>
            </div>
          </div>
        </div>
